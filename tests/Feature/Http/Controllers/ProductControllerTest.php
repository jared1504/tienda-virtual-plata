...
class ProductControllerTest extends TestCase
{
    ...
    public function store_saves_and_redirects()
    {
        ...
        $height = $this->faker->randomFloat(/** double_attributes **/);
        $width = $this->faker->randomFloat(/** double_attributes **/);
    ...
    public function update_redirects()
    {
        ...
        $this->assertEquals($height, $product->height);
        $this->assertEquals($width, $product->width);
