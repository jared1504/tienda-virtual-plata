...
<x-dashboard :items="$items">
    <h1 class='font-black text-4xl text-blue-900'>Agregar Producto</h1>
    <p class="mt-3 text-lg">Llena los siguientes campos para agregar un Producto</p>
    ...
    <form class=' my-5 p-5 w-4/5 mx-auto  rounded-lg bg-white drop-shadow-2xl grid grid-cols-3 gap-5'
        ...
        @csrf
        <p class="text-2xl text-center font-bold mb-5 col-span-3">Llena los campos para agregar un Producto</p>
        ...
        <div class="my-4 col-span-1">
            ...
            <input class="mt-2 block w-full p-3 bg-gray-100 text-lg focus:outline-none" value="{{old('price')}}"
        ...
        <div class="my-4">
            ...
            <input class="mt-2 block w-full p-3 bg-gray-100 text-lg focus:outline-none" value="{{old('height')}}"
        ...
        <div class="my-4">
            ...
            <input class="mt-2 block w-full p-3 bg-gray-100 text-lg focus:outline-none" value="{{old('width')}}"
        ...
        <div class="my-4">
            ...
            <input class="mt-2 block w-full p-3 bg-gray-100 text-lg focus:outline-none" value="{{old('weight')}}"
        ...
        <div class="my-4 col-span-3">
            ...
            <input class="mt-2 block w-full p-3 bg-gray-100 text-lg focus:outline-none" value="{{old('image')}}"
